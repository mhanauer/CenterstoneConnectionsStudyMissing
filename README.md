...
m = 10
PHQ9_GAD7LongMissingDesOut = amelia(m = 10, PHQ9_GAD7LongCenter, noms = c("Employment.x", "LivingWhere.x", "Gender.x", "EducationYears.x"), ords = c("Depression.x", "Anxiety.x","ArrestedDays.x", "DAUseIllegDrugsDays.x"), ts = "time")
