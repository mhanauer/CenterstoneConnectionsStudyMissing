...
```{r}
PHQ9_GAD7Cat = data.frame(PHQ9_GAD7$Employment.x, PHQ9_GAD7$LivingWhere.x, PHQ9_GAD7$HealthStatus.x, PHQ9_GAD7$EducationYears.x, PHQ9_GAD7$Gender.x, PHQ9_GAD7$County.x)
